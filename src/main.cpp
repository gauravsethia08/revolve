...
void globalPlanner(mjModel* model, mjData* data, Visualizer& visualizer)
{
    ...
    double goal_anglesV_rad[num_of_dofs] = {0.0578656, 0.00484065, -0.0000967339, -1.55885, -0.000475122, 2.09537, 2.8968};//{0.115885, 0.342909, -0.231399, -0.810337, 0.0577116, 1.39522, 2.89704};//{0.0, 0.331, -0.203, -0.835, -0.145, 1.83, -2.9}; //{-0.145, 0.423, 0, -1.57079, -1.57, 1.4, 0.464};
...
void localPlanner(mjModel* model, mjData* data, Visualizer& visualizer)
{
	...
	double goal_anglesV_rad[num_of_dofs] = { -0.552715, 0.0559791, 1.44565, 0.42832, -0.293626, 0.113725, 1.37835, 0.442406, -0.0584939, 0.217719, 1.26196, 0.380962, 1.39196, -0.108564, 1.21286, -0.104381};//{-0.00725476, 0.287009, -0.0878901, -0.0324261, -0.00516717, 0.355593, -0.0676449, -0.0278528, 0.00202279, 0.38239, -0.00351541, -0.00111891, 1.39599, 0.165781, 0.725218, 1.15223}; //{0.0, 0.924, 0.165, -0.061, 0.0, 1.06, 0.0, 0.0, 0.0, 1.09, 0.0, 0.0, 0.767, 1.16, 1.4, 0.0};//{0.193, 1.03, 0.862, 0.373, 0.103, 0.96, 1.03, 0.363, 0.0, 0.933, 1.02, 0.566, 1.07, 0.802, 0.847};
